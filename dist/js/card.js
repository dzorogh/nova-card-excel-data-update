...
Nova.booting(function (Vue, router, store) {
  Vue.component('excel-data-update', __webpack_require__(2));
});
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                 ...
                 */
                _context2.next = 6;
                return Nova.request().post('/nova-vendor/excel-data-update/upload', formData, {
                  headers: {
...
var render = function() {
  ...
  return _c(
    "card",
    { staticClass: "py-6 px-6", staticStyle: { height: "auto" } },
    [
      _c("h1", { staticClass: "mb-6 text-xl font-bold text-center" }, [
      ...
      _c("div", { staticClass: "flex flex-row" }, [
        _c(
          "div",
          {
            staticClass: "flex-1 text-center flex items-center justify-center"
          },
          [
            _c(
              "button",
              {
                staticClass: "btn btn-default btn-primary select-none",
                attrs: { type: "button" },
                on: {
        ...
        _c(
          ...
          {
            staticClass:
              "flex-1 text-center flex-col items-center justify-center"
          },
          [
